...
//	I2Cx->I2CONSET = 0x40;
//	UART0_PrintString("Sending I2C start cond\n\r");
	// Wait for complete
	while (!(I2Cx->I2CONSET & I2C_I2CONSET_SI));
//	UART0_PrintString("Completed\n\r");
...
void I2C_IntCmd (LPC_I2C_TypeDef *I2Cx, Bool NewState)
{
	if (NewState)
	{
		...
		//	UART0_PrintString("I2C0 Interrupt enabled\n\r");
		}
		else if (I2Cx == LPC_I2C1)
		{
...
//	UART0_PrintString("In I2C_MasterHandler\n\r");
	tmp = I2C_getNum(I2Cx);
								...
								I2C_TRANSFER_OPT_Type Opt)
{
	...
	if (Opt == I2C_TRANSFER_POLLING){
		//UART0_PrintString("Using polling to transfer data\n\r");
...
retry:
		...
		if ((CodeStatus != I2C_I2STAT_M_TX_START) \
			...
			//UART0_PrintString("Sent start command\n\r");
		...
		{
			//UART0_PrintString("Failed to send start command\n\r");
		}
...
error:
		...
		//UART0_PrintString("Interrupt mode\n\r");
		tmp = I2C_getNum(I2Cx);
...
{
//	UART0_PrintString("In I2C0_StdIntHandler\n\r");
